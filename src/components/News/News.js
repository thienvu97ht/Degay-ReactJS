              ...
              <div className="col l-4 m-12 c-10 c-o-1 ">
                <div className="container__product-item">
                  ...
                  <p className="news-text-content">
                    1.000.000 FOLLOWERS ON FACEBOOK- Cảm ơn các bạn đồng hành
                    cùng Degrey suốt thời gian qua. Để đền đáp lại mọi sự yêu
                    thương vô bờ bến tụi mình xin phép tổ chức event như sau.-
                    Với mỗi hoá đơn từ 1 triệu đồng (1.000.000vnd)...
                  </p>
                </div>
              </div>
              <div className="col l-4 m-12 c-10 c-o-1">
                <div className="container__product-item">
                  ...
                  <p className="news-text-content">
                    ...
                    phong cách thời trang đường phố, mới đây đã cho thay đổi
                    logo của mình nhằm kêu gọi tất cả mọi người tự cách ly tại
                    nhà, chủ động bảo vệ bản thân...
                  </p>
                </div>
              </div>
              <div className="col l-4 m-12 c-10 c-o-1">
                <div className="container__product-item">
                  ...
                  <p className="news-text-content">
                    MAKE LOVE NOT WAR - DEGREY x DIRTY COINSPhát hành 11 giờ 11
                    phút sáng ngày 09/02/2020. Bộ sưu tập được bán tại trang
                    mạng http://degrey.vn - http://dirtycoins.vn
                  </p>
                </div>
              </div>
            </div>
